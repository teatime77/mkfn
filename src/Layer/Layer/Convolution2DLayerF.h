class DllExport Convolution2DLayerF : public Layer {
public:
    int M;
    int N;
    int K;
	...
	Convolution2DLayerF(int m_size, int n_size, int k_size, int cm_size, int cn_size);
	virtual ~Convolution2DLayerF();
