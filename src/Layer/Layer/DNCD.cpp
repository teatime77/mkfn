...
void DNCD::GetFieldName(int field_idx, wchar_t* name){
	switch(field_idx){
...
int DNCD::GetFieldDimension(int field_idx){
	switch(field_idx){
	case 0: return 0;
	case 1: return 0;
	case 2: return 0;
...
int* DNCD::GetFieldSize(int field_idx){
	switch(field_idx){
	case 0: return 0;
	case 1: return 0;
	case 2: return 0;
...
void DNCD::GetFieldValue(int field_idx, void* dst){
...
void DNCD::SetFieldValue(int field_idx, void* src){
	int _cnt = GetFieldElementCount(field_idx);
	switch(field_idx){
...
extern "C" DllExport Layer* MakeDNCD(){
	return new DNCD();
}
