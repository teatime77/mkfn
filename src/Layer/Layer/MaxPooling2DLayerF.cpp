...
#include "MkFn.h"
#include "../../Lib/Lib.h"
#include "MaxPooling2DLayerF.h"

void MaxPooling2DLayerF::GetFieldName(int field_idx, wchar_t* name){
	switch(field_idx){
...
int MaxPooling2DLayerF::GetFieldDimension(int field_idx){
	switch(field_idx){
	case 0: return 0;
	case 1: return 0;
	case 2: return 0;
...
int* MaxPooling2DLayerF::GetFieldSize(int field_idx){
	switch(field_idx){
	case 0: return 0;
	case 1: return 0;
	case 2: return 0;
...
void MaxPooling2DLayerF::GetFieldValue(int field_idx, void* dst){
...
void MaxPooling2DLayerF::SetFieldValue(int field_idx, void* src){
	int _cnt = GetFieldElementCount(field_idx);
	switch(field_idx){
...
MaxPooling2DLayerF::MaxPooling2DLayerF(int m_size, int n_size, int k_size, int pm_size, int pn_size){
...
MaxPooling2DLayerF::~MaxPooling2DLayerF(){
	Free();

}

void MaxPooling2DLayerF::Allocate(){
...
void MaxPooling2DLayerF::Free(){
	_chk(_Free(y)); 
	_chk(_Free(delta_x)); 
	_chk(_Free(_idx_x)); 
}
void MaxPooling2DLayerF::Forward(){
...
void MaxPooling2DLayerF::Backward(){
#pragma omp parallel for
...
void MaxPooling2DLayerF::UpdateParameter(){
}

extern "C" DllExport Layer* MakeMaxPooling2DLayerF(int m_size, int n_size, int k_size, int pm_size, int pn_size){
	return new MaxPooling2DLayerF(m_size, n_size, k_size, pm_size, pn_size);
}
