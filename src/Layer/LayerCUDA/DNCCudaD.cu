...
void DNCCudaD::GetFieldName(int field_idx, wchar_t* name){
	switch(field_idx){
...
int DNCCudaD::GetFieldDimension(int field_idx){
	switch(field_idx){
	case 0: return 0;
	case 1: return 0;
	case 2: return 0;
...
int* DNCCudaD::GetFieldSize(int field_idx){
	switch(field_idx){
	case 0: return 0;
	case 1: return 0;
	case 2: return 0;
...
void DNCCudaD::GetFieldValue(int field_idx, void* dst){
	...
	case 8: memcpy(dst, χ, _cnt * sizeof(double)); break;
	case 9: memcpy(dst, χ2h, _cnt * sizeof(double)); break;
	case 10: memcpy(dst, gin, _cnt * sizeof(double)); break;
	case 11: memcpy(dst, gfo, _cnt * sizeof(double)); break;
	case 12: memcpy(dst, s, _cnt * sizeof(double)); break;
	case 13: memcpy(dst, o, _cnt * sizeof(double)); break;
	case 14: memcpy(dst, h, _cnt * sizeof(double)); break;
	case 15: memcpy(dst, Wi, _cnt * sizeof(double)); break;
	case 16: memcpy(dst, Wf, _cnt * sizeof(double)); break;
	case 17: memcpy(dst, Ws, _cnt * sizeof(double)); break;
	case 18: memcpy(dst, Wo, _cnt * sizeof(double)); break;
	case 19: memcpy(dst, bi, _cnt * sizeof(double)); break;
	case 20: memcpy(dst, bf, _cnt * sizeof(double)); break;
	case 21: memcpy(dst, bs, _cnt * sizeof(double)); break;
	case 22: memcpy(dst, bo, _cnt * sizeof(double)); break;
	case 23: memcpy(dst, x, _cnt * sizeof(double)); break;
	case 24: memcpy(dst, y, _cnt * sizeof(double)); break;
	case 25: memcpy(dst, v, _cnt * sizeof(double)); break;
	case 26: memcpy(dst, z, _cnt * sizeof(double)); break;
	case 27: memcpy(dst, M, _cnt * sizeof(double)); break;
	case 28: memcpy(dst, kr, _cnt * sizeof(double)); break;
	case 29: memcpy(dst, r, _cnt * sizeof(double)); break;
	case 30: memcpy(dst, βr, _cnt * sizeof(double)); break;
	case 31: memcpy(dst, kw, _cnt * sizeof(double)); break;
	case 32: memcpy(dst, βw, _cnt * sizeof(double)); break;
	case 33: memcpy(dst, e, _cnt * sizeof(double)); break;
	case 34: memcpy(dst, ν, _cnt * sizeof(double)); break;
	case 35: memcpy(dst, gf, _cnt * sizeof(double)); break;
	case 36: memcpy(dst, ga, _cnt * sizeof(double)); break;
	case 37: memcpy(dst, gw, _cnt * sizeof(double)); break;
	case 38: memcpy(dst, ψ, _cnt * sizeof(double)); break;
	case 39: memcpy(dst, u, _cnt * sizeof(double)); break;
	case 40: memcpy(dst, φ, _cnt * sizeof(int)); break;
	case 41: memcpy(dst, a, _cnt * sizeof(double)); break;
	case 42: memcpy(dst, cw, _cnt * sizeof(double)); break;
	case 43: memcpy(dst, ww, _cnt * sizeof(double)); break;
	case 44: memcpy(dst, p, _cnt * sizeof(double)); break;
	case 45: memcpy(dst, L, _cnt * sizeof(double)); break;
	case 46: memcpy(dst, f, _cnt * sizeof(double)); break;
	case 47: memcpy(dst, b, _cnt * sizeof(double)); break;
	case 48: memcpy(dst, cr, _cnt * sizeof(double)); break;
	case 49: memcpy(dst, wr, _cnt * sizeof(double)); break;
	case 50: memcpy(dst, π1, _cnt * sizeof(double)); break;
	case 51: memcpy(dst, π2, _cnt * sizeof(double)); break;
	case 52: memcpy(dst, π3, _cnt * sizeof(double)); break;
	case 53: memcpy(dst, Wr, _cnt * sizeof(double)); break;
	case 54: memcpy(dst, delta_χ, _cnt * sizeof(double)); break;
	case 55: memcpy(dst, delta_χ2h, _cnt * sizeof(double)); break;
	case 56: memcpy(dst, delta_gin, _cnt * sizeof(double)); break;
	case 57: memcpy(dst, delta_gfo, _cnt * sizeof(double)); break;
	case 58: memcpy(dst, delta_s, _cnt * sizeof(double)); break;
	case 59: memcpy(dst, delta_o, _cnt * sizeof(double)); break;
	case 60: memcpy(dst, delta_h, _cnt * sizeof(double)); break;
	case 61: memcpy(dst, delta_Wi, _cnt * sizeof(double)); break;
	case 62: memcpy(dst, delta_Wf, _cnt * sizeof(double)); break;
	case 63: memcpy(dst, delta_Ws, _cnt * sizeof(double)); break;
	case 64: memcpy(dst, delta_Wo, _cnt * sizeof(double)); break;
	case 65: memcpy(dst, delta_bi, _cnt * sizeof(double)); break;
	case 66: memcpy(dst, delta_bf, _cnt * sizeof(double)); break;
	case 67: memcpy(dst, delta_bs, _cnt * sizeof(double)); break;
	case 68: memcpy(dst, delta_bo, _cnt * sizeof(double)); break;
	case 69: memcpy(dst, delta_x, _cnt * sizeof(double)); break;
	case 70: memcpy(dst, delta_y, _cnt * sizeof(double)); break;
	case 71: memcpy(dst, delta_v, _cnt * sizeof(double)); break;
	case 72: memcpy(dst, delta_z, _cnt * sizeof(double)); break;
	case 73: memcpy(dst, delta_M, _cnt * sizeof(double)); break;
	case 74: memcpy(dst, delta_kr, _cnt * sizeof(double)); break;
	case 75: memcpy(dst, delta_r, _cnt * sizeof(double)); break;
	case 76: memcpy(dst, delta_βr, _cnt * sizeof(double)); break;
	case 77: memcpy(dst, delta_kw, _cnt * sizeof(double)); break;
	case 78: memcpy(dst, delta_βw, _cnt * sizeof(double)); break;
	case 79: memcpy(dst, delta_e, _cnt * sizeof(double)); break;
	case 80: memcpy(dst, delta_ν, _cnt * sizeof(double)); break;
	case 81: memcpy(dst, delta_gf, _cnt * sizeof(double)); break;
	case 82: memcpy(dst, delta_ga, _cnt * sizeof(double)); break;
	case 83: memcpy(dst, delta_gw, _cnt * sizeof(double)); break;
	case 84: memcpy(dst, delta_ψ, _cnt * sizeof(double)); break;
	case 85: memcpy(dst, delta_u, _cnt * sizeof(double)); break;
	case 86: memcpy(dst, delta_φ, _cnt * sizeof(int)); break;
	case 87: memcpy(dst, delta_a, _cnt * sizeof(double)); break;
	case 88: memcpy(dst, delta_cw, _cnt * sizeof(double)); break;
	case 89: memcpy(dst, delta_ww, _cnt * sizeof(double)); break;
	case 90: memcpy(dst, delta_p, _cnt * sizeof(double)); break;
	case 91: memcpy(dst, delta_L, _cnt * sizeof(double)); break;
	case 92: memcpy(dst, delta_f, _cnt * sizeof(double)); break;
	case 93: memcpy(dst, delta_b, _cnt * sizeof(double)); break;
	case 94: memcpy(dst, delta_cr, _cnt * sizeof(double)); break;
	case 95: memcpy(dst, delta_wr, _cnt * sizeof(double)); break;
	case 96: memcpy(dst, delta_π1, _cnt * sizeof(double)); break;
	case 97: memcpy(dst, delta_π2, _cnt * sizeof(double)); break;
	case 98: memcpy(dst, delta_π3, _cnt * sizeof(double)); break;
	case 99: memcpy(dst, delta_Wr, _cnt * sizeof(double)); break;
	}
}

void DNCCudaD::SetFieldValue(int field_idx, void* src){
	int _cnt = GetFieldElementCount(field_idx);
	switch(field_idx){
	...
	case 8: memcpy(χ, src, _cnt * sizeof(double)); break;
	case 9: memcpy(χ2h, src, _cnt * sizeof(double)); break;
	case 10: memcpy(gin, src, _cnt * sizeof(double)); break;
	case 11: memcpy(gfo, src, _cnt * sizeof(double)); break;
	case 12: memcpy(s, src, _cnt * sizeof(double)); break;
	case 13: memcpy(o, src, _cnt * sizeof(double)); break;
	case 14: memcpy(h, src, _cnt * sizeof(double)); break;
	case 15: memcpy(Wi, src, _cnt * sizeof(double)); break;
	case 16: memcpy(Wf, src, _cnt * sizeof(double)); break;
	case 17: memcpy(Ws, src, _cnt * sizeof(double)); break;
	case 18: memcpy(Wo, src, _cnt * sizeof(double)); break;
	case 19: memcpy(bi, src, _cnt * sizeof(double)); break;
	case 20: memcpy(bf, src, _cnt * sizeof(double)); break;
	case 21: memcpy(bs, src, _cnt * sizeof(double)); break;
	case 22: memcpy(bo, src, _cnt * sizeof(double)); break;
	case 23: memcpy(x, src, _cnt * sizeof(double)); break;
	case 24: memcpy(y, src, _cnt * sizeof(double)); break;
	case 25: memcpy(v, src, _cnt * sizeof(double)); break;
	case 26: memcpy(z, src, _cnt * sizeof(double)); break;
	case 27: memcpy(M, src, _cnt * sizeof(double)); break;
	case 28: memcpy(kr, src, _cnt * sizeof(double)); break;
	case 29: memcpy(r, src, _cnt * sizeof(double)); break;
	case 30: memcpy(βr, src, _cnt * sizeof(double)); break;
	case 31: memcpy(kw, src, _cnt * sizeof(double)); break;
	case 32: memcpy(βw, src, _cnt * sizeof(double)); break;
	case 33: memcpy(e, src, _cnt * sizeof(double)); break;
	case 34: memcpy(ν, src, _cnt * sizeof(double)); break;
	case 35: memcpy(gf, src, _cnt * sizeof(double)); break;
	case 36: memcpy(ga, src, _cnt * sizeof(double)); break;
	case 37: memcpy(gw, src, _cnt * sizeof(double)); break;
	case 38: memcpy(ψ, src, _cnt * sizeof(double)); break;
	case 39: memcpy(u, src, _cnt * sizeof(double)); break;
	case 40: memcpy(φ, src, _cnt * sizeof(int)); break;
	case 41: memcpy(a, src, _cnt * sizeof(double)); break;
	case 42: memcpy(cw, src, _cnt * sizeof(double)); break;
	case 43: memcpy(ww, src, _cnt * sizeof(double)); break;
	case 44: memcpy(p, src, _cnt * sizeof(double)); break;
	case 45: memcpy(L, src, _cnt * sizeof(double)); break;
	case 46: memcpy(f, src, _cnt * sizeof(double)); break;
	case 47: memcpy(b, src, _cnt * sizeof(double)); break;
	case 48: memcpy(cr, src, _cnt * sizeof(double)); break;
	case 49: memcpy(wr, src, _cnt * sizeof(double)); break;
	case 50: memcpy(π1, src, _cnt * sizeof(double)); break;
	case 51: memcpy(π2, src, _cnt * sizeof(double)); break;
	case 52: memcpy(π3, src, _cnt * sizeof(double)); break;
	case 53: memcpy(Wr, src, _cnt * sizeof(double)); break;
	case 54: memcpy(delta_χ, src, _cnt * sizeof(double)); break;
	case 55: memcpy(delta_χ2h, src, _cnt * sizeof(double)); break;
	case 56: memcpy(delta_gin, src, _cnt * sizeof(double)); break;
	case 57: memcpy(delta_gfo, src, _cnt * sizeof(double)); break;
	case 58: memcpy(delta_s, src, _cnt * sizeof(double)); break;
	case 59: memcpy(delta_o, src, _cnt * sizeof(double)); break;
	case 60: memcpy(delta_h, src, _cnt * sizeof(double)); break;
	case 61: memcpy(delta_Wi, src, _cnt * sizeof(double)); break;
	case 62: memcpy(delta_Wf, src, _cnt * sizeof(double)); break;
	case 63: memcpy(delta_Ws, src, _cnt * sizeof(double)); break;
	case 64: memcpy(delta_Wo, src, _cnt * sizeof(double)); break;
	case 65: memcpy(delta_bi, src, _cnt * sizeof(double)); break;
	case 66: memcpy(delta_bf, src, _cnt * sizeof(double)); break;
	case 67: memcpy(delta_bs, src, _cnt * sizeof(double)); break;
	case 68: memcpy(delta_bo, src, _cnt * sizeof(double)); break;
	case 69: memcpy(delta_x, src, _cnt * sizeof(double)); break;
	case 70: memcpy(delta_y, src, _cnt * sizeof(double)); break;
	case 71: memcpy(delta_v, src, _cnt * sizeof(double)); break;
	case 72: memcpy(delta_z, src, _cnt * sizeof(double)); break;
	case 73: memcpy(delta_M, src, _cnt * sizeof(double)); break;
	case 74: memcpy(delta_kr, src, _cnt * sizeof(double)); break;
	case 75: memcpy(delta_r, src, _cnt * sizeof(double)); break;
	case 76: memcpy(delta_βr, src, _cnt * sizeof(double)); break;
	case 77: memcpy(delta_kw, src, _cnt * sizeof(double)); break;
	case 78: memcpy(delta_βw, src, _cnt * sizeof(double)); break;
	case 79: memcpy(delta_e, src, _cnt * sizeof(double)); break;
	case 80: memcpy(delta_ν, src, _cnt * sizeof(double)); break;
	case 81: memcpy(delta_gf, src, _cnt * sizeof(double)); break;
	case 82: memcpy(delta_ga, src, _cnt * sizeof(double)); break;
	case 83: memcpy(delta_gw, src, _cnt * sizeof(double)); break;
	case 84: memcpy(delta_ψ, src, _cnt * sizeof(double)); break;
	case 85: memcpy(delta_u, src, _cnt * sizeof(double)); break;
	case 86: memcpy(delta_φ, src, _cnt * sizeof(int)); break;
	case 87: memcpy(delta_a, src, _cnt * sizeof(double)); break;
	case 88: memcpy(delta_cw, src, _cnt * sizeof(double)); break;
	case 89: memcpy(delta_ww, src, _cnt * sizeof(double)); break;
	case 90: memcpy(delta_p, src, _cnt * sizeof(double)); break;
	case 91: memcpy(delta_L, src, _cnt * sizeof(double)); break;
	case 92: memcpy(delta_f, src, _cnt * sizeof(double)); break;
	case 93: memcpy(delta_b, src, _cnt * sizeof(double)); break;
	case 94: memcpy(delta_cr, src, _cnt * sizeof(double)); break;
	case 95: memcpy(delta_wr, src, _cnt * sizeof(double)); break;
	case 96: memcpy(delta_π1, src, _cnt * sizeof(double)); break;
	case 97: memcpy(delta_π2, src, _cnt * sizeof(double)); break;
	case 98: memcpy(delta_π3, src, _cnt * sizeof(double)); break;
	case 99: memcpy(delta_Wr, src, _cnt * sizeof(double)); break;
	}
}
...
void DNCCudaD::Allocate(){
	_chk(_Malloc(gin, BatchSize * T * Y * sizeof(double))); 
	_chk(_Malloc(gfo, BatchSize * T * Y * sizeof(double))); 
	_chk(_Malloc(s, BatchSize * T * Y * sizeof(double))); 
	_chk(_Malloc(o, BatchSize * T * Y * sizeof(double))); 
	_chk(_Malloc(h, BatchSize * T * Y * sizeof(double))); 
	_chk(_Malloc(y, BatchSize * T * Y * sizeof(double))); 
	_chk(_Malloc(M, BatchSize * T * N * W * sizeof(double))); 
	_chk(_Malloc(r, BatchSize * T * R * W * sizeof(double))); 
	_chk(_Malloc(ψ, BatchSize * T * N * sizeof(double))); 
	_chk(_Malloc(u, BatchSize * T * N * sizeof(double))); 
	_chk(_Malloc(φ, BatchSize * T * N * sizeof(int))); 
	_chk(_Malloc(cw, BatchSize * T * N * sizeof(double))); 
	_chk(_Malloc(ww, BatchSize * T * N * sizeof(double))); 
	_chk(_Malloc(p, BatchSize * T * N * sizeof(double))); 
	_chk(_Malloc(L, BatchSize * T * N * N * sizeof(double))); 
	_chk(_Malloc(f, BatchSize * T * R * N * sizeof(double))); 
	_chk(_Malloc(b, BatchSize * T * R * N * sizeof(double))); 
	_chk(_Malloc(cr, BatchSize * T * R * N * sizeof(double))); 
	_chk(_Malloc(wr, BatchSize * T * R * N * sizeof(double))); 
	_chk(_Malloc(delta_χ, BatchSize * T * χl * sizeof(double))); 
	_chk(_Malloc(delta_χ2h, BatchSize * T * χ2hl * sizeof(double))); 
	_chk(_Malloc(delta_gin, BatchSize * T * Y * sizeof(double))); 
	_chk(_Malloc(delta_gfo, BatchSize * T * Y * sizeof(double))); 
	_chk(_Malloc(delta_s, BatchSize * T * Y * sizeof(double))); 
	_chk(_Malloc(delta_o, BatchSize * T * Y * sizeof(double))); 
	_chk(_Malloc(delta_h, BatchSize * T * Y * sizeof(double))); 
	_chk(_Malloc(delta_Wi, BatchSize * Y * χ2hl * sizeof(double))); 
	_chk(_Malloc(delta_Wf, BatchSize * Y * χ2hl * sizeof(double))); 
	_chk(_Malloc(delta_Ws, BatchSize * Y * χ2hl * sizeof(double))); 
	_chk(_Malloc(delta_Wo, BatchSize * Y * χ2hl * sizeof(double))); 
	_chk(_Malloc(delta_bi, BatchSize * Y * sizeof(double))); 
	_chk(_Malloc(delta_bf, BatchSize * Y * sizeof(double))); 
	_chk(_Malloc(delta_bs, BatchSize * Y * sizeof(double))); 
	_chk(_Malloc(delta_bo, BatchSize * Y * sizeof(double))); 
	_chk(_Malloc(delta_x, BatchSize * T * X * sizeof(double))); 
	_chk(_Malloc(delta_v, BatchSize * T * Y * sizeof(double))); 
	_chk(_Malloc(delta_z, BatchSize * T * Y * sizeof(double))); 
	_chk(_Malloc(delta_M, BatchSize * T * N * W * sizeof(double))); 
	_chk(_Malloc(delta_kr, BatchSize * T * R * W * sizeof(double))); 
	_chk(_Malloc(delta_r, BatchSize * T * R * W * sizeof(double))); 
	_chk(_Malloc(delta_βr, BatchSize * T * R * sizeof(double))); 
	_chk(_Malloc(delta_kw, BatchSize * T * W * sizeof(double))); 
	_chk(_Malloc(delta_βw, BatchSize * T * sizeof(double))); 
	_chk(_Malloc(delta_e, BatchSize * T * W * sizeof(double))); 
	_chk(_Malloc(delta_ν, BatchSize * T * W * sizeof(double))); 
	_chk(_Malloc(delta_gf, BatchSize * T * R * sizeof(double))); 
	_chk(_Malloc(delta_ga, BatchSize * T * sizeof(double))); 
	_chk(_Malloc(delta_gw, BatchSize * T * sizeof(double))); 
	_chk(_Malloc(delta_ψ, BatchSize * T * N * sizeof(double))); 
	_chk(_Malloc(delta_u, BatchSize * T * N * sizeof(double))); 
	_chk(_Malloc(delta_φ, BatchSize * T * N * sizeof(int))); 
	_chk(_Malloc(delta_a, BatchSize * T * N * sizeof(double))); 
	_chk(_Malloc(delta_cw, BatchSize * T * N * sizeof(double))); 
	_chk(_Malloc(delta_ww, BatchSize * T * N * sizeof(double))); 
	_chk(_Malloc(delta_p, BatchSize * T * N * sizeof(double))); 
	_chk(_Malloc(delta_L, BatchSize * T * N * N * sizeof(double))); 
	_chk(_Malloc(delta_f, BatchSize * T * R * N * sizeof(double))); 
	_chk(_Malloc(delta_b, BatchSize * T * R * N * sizeof(double))); 
	_chk(_Malloc(delta_cr, BatchSize * T * R * N * sizeof(double))); 
	_chk(_Malloc(delta_wr, BatchSize * T * R * N * sizeof(double))); 
	_chk(_Malloc(delta_π1, BatchSize * T * R * sizeof(double))); 
	_chk(_Malloc(delta_π2, BatchSize * T * R * sizeof(double))); 
	_chk(_Malloc(delta_π3, BatchSize * T * R * sizeof(double))); 
	_chk(_Malloc(delta_Wr, BatchSize * R * W * Y * sizeof(double))); 
}
...
__global__ static void forward_gin(double* gin, int χ2hl, double* Wi, double* χ2h, double* bi, int T, int Y, int t){
...
void DNCCudaD::Start_forward_gin(){
	int blocks_x = 1;
	int blocks_y = 1;
	int blocks_z = 1;
	blocks_x = Y;
...
__global__ static void forward_gfo(double* gfo, int χ2hl, double* Wf, double* χ2h, double* bf, int T, int Y, int t){
	int _batch_idx = threadIdx.x;
	int iy = blockIdx.x;
...
void DNCCudaD::Start_forward_gfo(){
	int blocks_x = 1;
	int blocks_y = 1;
	int blocks_z = 1;
	blocks_x = Y;
...
__global__ static void forward_s(double* s, double* gfo, double* gin, int χ2hl, double* Ws, double* χ2h, double* bs, int T, int Y, int t){
	int _batch_idx = threadIdx.x;
	int iy = blockIdx.x;
...
__global__ static void forward_o(double* o, int χ2hl, double* Wo, double* χ2h, double* bo, int T, int Y, int t){
	int _batch_idx = threadIdx.x;
	int iy = blockIdx.x;
...
__global__ static void forward_h(double* h, double* o, double* s, int T, int Y, int t){
	int _batch_idx = threadIdx.x;
	int iy = blockIdx.x;
...
__global__ static void forward_ψ(double* ψ, int R, double* gf, double* wr, int T, int N, int t){
	int _batch_idx = threadIdx.x;
	int n = blockIdx.x;
...
__global__ static void forward_u(double* u, double* ww, double* ψ, int T, int N, int t){
	int _batch_idx = threadIdx.x;
	int n = blockIdx.x;
...
__global__ static void forward_y(double* y, int T, int Y, int t){
	int _batch_idx = threadIdx.x;
	int iy = blockIdx.x;
...
__global__ static void backward_delta_s(double* delta_s, double* gfo, double* delta_h, double* o, double* s, int T, int Y, int t){
	int _batch_idx = threadIdx.x;
	int iy = blockIdx.x;
...
void DNCCudaD::Start_backward_delta_s(){
	int blocks_x = 1;
	int blocks_y = 1;
	int blocks_z = 1;
	blocks_x = Y;
...
__global__ static void backward_delta_gin(double* delta_gin, double* delta_s, int χ2hl, double* Ws, double* χ2h, double* bs, int T, int Y, int t){
	int _batch_idx = threadIdx.x;
	int iy = blockIdx.x;
...
void DNCCudaD::Start_backward_delta_gin(){
	int blocks_x = 1;
	int blocks_y = 1;
	int blocks_z = 1;
	blocks_x = Y;
...
__global__ static void backward_delta_gfo(double* delta_gfo, double* delta_s, double* s, int T, int Y, int t){
	int _batch_idx = threadIdx.x;
	int iy = blockIdx.x;
...
void DNCCudaD::Start_backward_delta_gfo(){
	int blocks_x = 1;
	int blocks_y = 1;
	int blocks_z = 1;
	blocks_x = Y;
...
__global__ static void backward_delta_o(double* delta_o, double* delta_h, double* s, int T, int Y, int t){
	int _batch_idx = threadIdx.x;
	int iy = blockIdx.x;
...
void DNCCudaD::Start_backward_delta_o(){
	int blocks_x = 1;
	int blocks_y = 1;
	int blocks_z = 1;
	blocks_x = Y;
...
__global__ static void backward_delta_χ2h(double* delta_χ2h, int Y, double* delta_gin, double* Wi, double* χ2h, double* bi, double* delta_gfo, double* Wf, double* bf, double* delta_s, double* gin, double* Ws, double* bs, double* delta_o, double* Wo, double* bo, int T, int χ2hl, int t){
	int _batch_idx = threadIdx.x;
	int i_ix = blockIdx.x;
...
void DNCCudaD::Start_backward_delta_χ2h(){
	int blocks_x = 1;
	int blocks_y = 1;
	int blocks_z = 1;
	blocks_x = χ2hl;
...
__global__ static void backward_delta_Wi(double* delta_Wi, int T, double* delta_gin, double* Wi, double* χ2h, double* bi, int Y, int χ2hl, int t){
	int _batch_idx = threadIdx.x;
	int iy = blockIdx.y;
	int i_ix = blockIdx.x;
...
void DNCCudaD::Start_backward_delta_Wi(){
	int blocks_x = 1;
	int blocks_y = 1;
	int blocks_z = 1;
	blocks_y = Y;
...
__global__ static void backward_delta_Wf(double* delta_Wf, int T, double* delta_gfo, double* Wf, double* χ2h, double* bf, int Y, int χ2hl, int t){
	int _batch_idx = threadIdx.x;
	int iy = blockIdx.y;
	int i_ix = blockIdx.x;
...
void DNCCudaD::Start_backward_delta_Wf(){
	int blocks_x = 1;
	int blocks_y = 1;
	int blocks_z = 1;
	blocks_y = Y;
...
__global__ static void backward_delta_Ws(double* delta_Ws, int T, double* delta_s, double* gin, double* Ws, double* χ2h, double* bs, int Y, int χ2hl, int t){
	int _batch_idx = threadIdx.x;
	int iy = blockIdx.y;
	int i_ix = blockIdx.x;
...
void DNCCudaD::Start_backward_delta_Ws(){
	int blocks_x = 1;
	int blocks_y = 1;
	int blocks_z = 1;
	blocks_y = Y;
...
__global__ static void backward_delta_Wo(double* delta_Wo, int T, double* delta_o, double* Wo, double* χ2h, double* bo, int Y, int χ2hl, int t){
	int _batch_idx = threadIdx.x;
	int iy = blockIdx.y;
	int i_ix = blockIdx.x;
...
void DNCCudaD::Start_backward_delta_Wo(){
	int blocks_x = 1;
	int blocks_y = 1;
	int blocks_z = 1;
	blocks_y = Y;
...
__global__ static void backward_delta_bi(double* delta_bi, int T, double* delta_gin, int χ2hl, double* Wi, double* χ2h, double* bi, int Y, int t){
	int _batch_idx = threadIdx.x;
	int iy = blockIdx.x;
...
void DNCCudaD::Start_backward_delta_bi(){
	int blocks_x = 1;
	int blocks_y = 1;
	int blocks_z = 1;
	blocks_x = Y;
...
__global__ static void backward_delta_bf(double* delta_bf, int T, double* delta_gfo, int χ2hl, double* Wf, double* χ2h, double* bf, int Y, int t){
	int _batch_idx = threadIdx.x;
	int iy = blockIdx.x;
...
void DNCCudaD::Start_backward_delta_bf(){
	int blocks_x = 1;
	int blocks_y = 1;
	int blocks_z = 1;
	blocks_x = Y;
...
__global__ static void backward_delta_bs(double* delta_bs, int T, double* delta_s, double* gin, int χ2hl, double* Ws, double* χ2h, double* bs, int Y, int t){
	int _batch_idx = threadIdx.x;
	int iy = blockIdx.x;
...
void DNCCudaD::Start_backward_delta_bs(){
	int blocks_x = 1;
	int blocks_y = 1;
	int blocks_z = 1;
	blocks_x = Y;
...
__global__ static void backward_delta_bo(double* delta_bo, int T, double* delta_o, int χ2hl, double* Wo, double* χ2h, double* bo, int Y, int t){
	int _batch_idx = threadIdx.x;
	int iy = blockIdx.x;
...
void DNCCudaD::Start_backward_delta_bo(){
	int blocks_x = 1;
	int blocks_y = 1;
	int blocks_z = 1;
	blocks_x = Y;
...
__global__ static void backward_delta_M(double* delta_M, double* ww, double* e, int R, double* delta_r, double* wr, int T, int N, int W, int t){
	int _batch_idx = threadIdx.x;
	int n = blockIdx.y;
	int iw = blockIdx.x;
...
void DNCCudaD::Start_backward_delta_M(){
	int blocks_x = 1;
	int blocks_y = 1;
	int blocks_z = 1;
	blocks_y = N;
...
__global__ static void backward_delta_βr(double* delta_βr, int N, int T, int R, int t){
	int _batch_idx = threadIdx.x;
	int ir = blockIdx.x;
...
void DNCCudaD::Start_backward_delta_βr(){
	int blocks_x = 1;
	int blocks_y = 1;
	int blocks_z = 1;
	blocks_x = R;
...
__global__ static void backward_delta_βw(double* delta_βw, int N, int T, int t){
	int _batch_idx = threadIdx.x;
...
void DNCCudaD::Start_backward_delta_βw(){
	int blocks_x = 1;
	int blocks_y = 1;
	int blocks_z = 1;
	dim3 threadsPerBlock = dim3(BatchSize);
...
__global__ static void backward_delta_e(double* delta_e, int N, double* delta_M, double* M, double* ww, int T, int W, int t){
	int _batch_idx = threadIdx.x;
	int iw = blockIdx.x;
...
void DNCCudaD::Start_backward_delta_e(){
	int blocks_x = 1;
	int blocks_y = 1;
	int blocks_z = 1;
	blocks_x = W;
...
__global__ static void backward_delta_ν(double* delta_ν, int N, double* delta_M, double* ww, int T, int W, int t){
	int _batch_idx = threadIdx.x;
	int iw = blockIdx.x;
...
void DNCCudaD::Start_backward_delta_ν(){
	int blocks_x = 1;
	int blocks_y = 1;
	int blocks_z = 1;
	blocks_x = W;
...
__global__ static void backward_delta_u(double* delta_u, double* ww, double* ψ, int T, int N, int t){
	int _batch_idx = threadIdx.x;
	int n = blockIdx.x;
...
void DNCCudaD::Start_backward_delta_u(){
	int blocks_x = 1;
	int blocks_y = 1;
	int blocks_z = 1;
	blocks_x = N;
...
__global__ static void backward_delta_ψ(double* delta_ψ, double* delta_u, double* u, double* ww, int T, int N, int t){
	int _batch_idx = threadIdx.x;
	int n = blockIdx.x;
...
void DNCCudaD::Start_backward_delta_ψ(){
	int blocks_x = 1;
	int blocks_y = 1;
	int blocks_z = 1;
	blocks_x = N;
...
__global__ static void backward_delta_gf(double* delta_gf, int N, double* delta_ψ, double* wr, int T, int R, int t){
	int _batch_idx = threadIdx.x;
	int i_ir = blockIdx.x;
...
void DNCCudaD::Start_backward_delta_gf(){
	int blocks_x = 1;
	int blocks_y = 1;
	int blocks_z = 1;
	blocks_x = R;
...
__global__ static void backward_delta_p(double* delta_p, int N, double* ww, double* delta_L, int T, int t){
	int _batch_idx = threadIdx.x;
	int n = blockIdx.x;
...
void DNCCudaD::Start_backward_delta_p(){
	int blocks_x = 1;
	int blocks_y = 1;
	int blocks_z = 1;
	blocks_x = N;
...
__global__ static void backward_delta_wr(double* delta_wr, double* delta_ψ, double* gf, int N, double* delta_f, double* L, double* delta_b, int W, double* delta_r, double* M, int T, int R, int t){
	int _batch_idx = threadIdx.x;
	int ir = blockIdx.y;
	int n = blockIdx.x;
...
void DNCCudaD::Start_backward_delta_wr(){
	int blocks_x = 1;
	int blocks_y = 1;
	int blocks_z = 1;
	blocks_y = R;
...
__global__ static void backward_delta_f(double* delta_f, double* delta_wr, double* π3, int T, int R, int N, int t){
	int _batch_idx = threadIdx.x;
	int ir = blockIdx.y;
	int n = blockIdx.x;
...
void DNCCudaD::Start_backward_delta_f(){
	int blocks_x = 1;
	int blocks_y = 1;
	int blocks_z = 1;
	blocks_y = R;
...
__global__ static void backward_delta_b(double* delta_b, double* delta_wr, double* π1, int T, int R, int N, int t){
	int _batch_idx = threadIdx.x;
	int ir = blockIdx.y;
	int n = blockIdx.x;
...
void DNCCudaD::Start_backward_delta_b(){
	int blocks_x = 1;
	int blocks_y = 1;
	int blocks_z = 1;
	blocks_y = R;
...
__global__ static void backward_delta_L(double* delta_L, double* ww, int R, double* delta_f, double* wr, double* delta_b, int T, int N, int t){
	int _batch_idx = threadIdx.x;
	int n = blockIdx.y;
	int j = blockIdx.x;
...
void DNCCudaD::Start_backward_delta_L(){
	int blocks_x = 1;
	int blocks_y = 1;
	int blocks_z = 1;
	blocks_y = N;
...
__global__ static void backward_delta_ww(double* delta_ww, double* delta_u, double* u, double* ψ, int W, double* delta_M, double* M, double* e, double* ν, int N, double* delta_p, double* p, double* delta_L, int T, int t){
	int _batch_idx = threadIdx.x;
	int n = blockIdx.x;
...
void DNCCudaD::Start_backward_delta_ww(){
	int blocks_x = 1;
	int blocks_y = 1;
	int blocks_z = 1;
	blocks_x = N;
...
__global__ static void backward_delta_ga(double* delta_ga, int N, double* delta_ww, double* gw, double* a, int T, int t){
	int _batch_idx = threadIdx.x;
...
void DNCCudaD::Start_backward_delta_ga(){
	int blocks_x = 1;
	int blocks_y = 1;
	int blocks_z = 1;
	dim3 threadsPerBlock = dim3(BatchSize);
...
__global__ static void backward_delta_gw(double* delta_gw, int N, double* delta_ww, double* ga, double* a, double* cw, int T, int t){
	int _batch_idx = threadIdx.x;
...
void DNCCudaD::Start_backward_delta_gw(){
	int blocks_x = 1;
	int blocks_y = 1;
	int blocks_z = 1;
	dim3 threadsPerBlock = dim3(BatchSize);
...
__global__ static void backward_delta_a(double* delta_a, double* delta_ww, double* gw, double* ga, int T, int N, int t){
	int _batch_idx = threadIdx.x;
	int n = blockIdx.x;
...
void DNCCudaD::Start_backward_delta_a(){
	int blocks_x = 1;
	int blocks_y = 1;
	int blocks_z = 1;
	blocks_x = N;
...
__global__ static void backward_delta_cw(double* delta_cw, double* delta_ww, double* gw, double* ga, int T, int N, int t){
	int _batch_idx = threadIdx.x;
	int n = blockIdx.x;
...
void DNCCudaD::Start_backward_delta_cw(){
	int blocks_x = 1;
	int blocks_y = 1;
	int blocks_z = 1;
	blocks_x = N;
...
__global__ static void backward_delta_cr(double* delta_cr, double* delta_wr, double* π2, int T, int R, int N, int t){
	int _batch_idx = threadIdx.x;
	int ir = blockIdx.y;
	int n = blockIdx.x;
...
void DNCCudaD::Start_backward_delta_cr(){
	int blocks_x = 1;
	int blocks_y = 1;
	int blocks_z = 1;
	blocks_y = R;
...
__global__ static void backward_delta_π1(double* delta_π1, int N, double* delta_wr, double* b, int T, int R, int t){
	int _batch_idx = threadIdx.x;
	int ir = blockIdx.x;
...
void DNCCudaD::Start_backward_delta_π1(){
	int blocks_x = 1;
	int blocks_y = 1;
	int blocks_z = 1;
	blocks_x = R;
...
__global__ static void backward_delta_π2(double* delta_π2, int N, double* delta_wr, double* cr, int T, int R, int t){
	int _batch_idx = threadIdx.x;
	int ir = blockIdx.x;
...
void DNCCudaD::Start_backward_delta_π2(){
	int blocks_x = 1;
	int blocks_y = 1;
	int blocks_z = 1;
	blocks_x = R;
...
__global__ static void backward_delta_π3(double* delta_π3, int N, double* delta_wr, double* f, int T, int R, int t){
	int _batch_idx = threadIdx.x;
	int ir = blockIdx.x;
...
void DNCCudaD::Start_backward_delta_π3(){
	int blocks_x = 1;
	int blocks_y = 1;
	int blocks_z = 1;
	blocks_x = R;
...
__global__ static void UpdateParameterKernel_0(double* χ, double* delta_χ){
...
void DNCCudaD::UpdateParameter_0(){
	int threads_x = 1;
	int blocks_x = 1;
	int blocks_y = 1;
	int blocks_z = 1;
...
__global__ static void UpdateParameterKernel_1(double* χ2h, double* delta_χ2h){
	int _idx = (blockIdx.x) * blockDim.x + threadIdx.x;
	int offset = _idx * _BatchSize;
	{
		double sum = 0;
...
void DNCCudaD::UpdateParameter_1(){
	int threads_x = 1;
	int blocks_x = 1;
	int blocks_y = 1;
	int blocks_z = 1;
...
__global__ static void UpdateParameterKernel_2(double* Wi, double* delta_Wi, double* Wf, double* delta_Wf, double* Ws, double* delta_Ws, double* Wo, double* delta_Wo){
	int _idx = (blockIdx.x) * blockDim.x + threadIdx.x;
	int offset = _idx * _BatchSize;
	{
		double sum = 0;
...
void DNCCudaD::UpdateParameter_2(){
	int threads_x = 1;
	int blocks_x = 1;
	int blocks_y = 1;
	int blocks_z = 1;
...
__global__ static void UpdateParameterKernel_3(double* bi, double* delta_bi, double* bf, double* delta_bf, double* bs, double* delta_bs, double* bo, double* delta_bo){
...
void DNCCudaD::UpdateParameter_3(){
	int threads_x = 1;
	int blocks_x = 1;
	int blocks_y = 1;
	int blocks_z = 1;
...
__global__ static void UpdateParameterKernel_4(double* v, double* delta_v, double* z, double* delta_z){
	int _idx = (blockIdx.x) * blockDim.x + threadIdx.x;
	int offset = _idx * _BatchSize;
	{
		double sum = 0;
...
void DNCCudaD::UpdateParameter_4(){
	int threads_x = 1;
	int blocks_x = 1;
	int blocks_y = 1;
	int blocks_z = 1;
...
__global__ static void UpdateParameterKernel_5(double* kr, double* delta_kr){
...
void DNCCudaD::UpdateParameter_5(){
	int threads_x = 1;
	int blocks_x = 1;
	int blocks_y = 1;
	int blocks_z = 1;
...
__global__ static void UpdateParameterKernel_6(double* βr, double* delta_βr, double* gf, double* delta_gf, double* π1, double* delta_π1, double* π2, double* delta_π2, double* π3, double* delta_π3){
	int _idx = (blockIdx.x) * blockDim.x + threadIdx.x;
	int offset = _idx * _BatchSize;
	{
		double sum = 0;
...
void DNCCudaD::UpdateParameter_6(){
	int threads_x = 1;
	int blocks_x = 1;
	int blocks_y = 1;
	int blocks_z = 1;
...
__global__ static void UpdateParameterKernel_7(double* kw, double* delta_kw, double* e, double* delta_e, double* ν, double* delta_ν){
	int _idx = (blockIdx.x) * blockDim.x + threadIdx.x;
	int offset = _idx * _BatchSize;
	{
		double sum = 0;
...
void DNCCudaD::UpdateParameter_7(){
	int threads_x = 1;
	int blocks_x = 1;
	int blocks_y = 1;
	int blocks_z = 1;
...
__global__ static void UpdateParameterKernel_8(double* βw, double* delta_βw, double* ga, double* delta_ga, double* gw, double* delta_gw){
	int _idx = threadIdx.x;
	int offset = _idx * _BatchSize;
	{
		double sum = 0;
...
void DNCCudaD::UpdateParameter_8(){
	int threads_x = 1;
	int blocks_x = 1;
	int blocks_y = 1;
	int blocks_z = 1;
...
__global__ static void UpdateParameterKernel_9(double* a, double* delta_a){
	int _idx = (blockIdx.x) * blockDim.x + threadIdx.x;
	int offset = _idx * _BatchSize;
	{
		double sum = 0;
...
void DNCCudaD::UpdateParameter_9(){
	int threads_x = 1;
	int blocks_x = 1;
	int blocks_y = 1;
	int blocks_z = 1;
...
__global__ static void UpdateParameterKernel_10(double* Wr, double* delta_Wr){
	int _idx = ((blockIdx.y) * gridDim.x + blockIdx.x) * blockDim.x + threadIdx.x;
	int offset = _idx * _BatchSize;
	{
		double sum = 0;
...
void DNCCudaD::UpdateParameter_10(){
	int threads_x = 1;
	int blocks_x = 1;
	int blocks_y = 1;
	int blocks_z = 1;
...
extern "C" DllExport Layer* MakeDNCCudaD(){
	return new DNCCudaD();
}
