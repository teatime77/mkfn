...
#include "../../Lib/Lib.h"
#include "LibCuda.h"
#include "LSTMLayerCudaD.h"
__constant__ int _BatchSize;
__constant__ double _LearningRate;

void LSTMLayerCudaD::GetFieldName(int field_idx, wchar_t* name){
	switch(field_idx){
...
int LSTMLayerCudaD::GetFieldDimension(int field_idx){
	switch(field_idx){
	case 0: return 0;
	case 1: return 0;
	case 2: return 0;
...
int* LSTMLayerCudaD::GetFieldSize(int field_idx){
	switch(field_idx){
	case 0: return 0;
	case 1: return 0;
	case 2: return 0;
...
void LSTMLayerCudaD::GetFieldValue(int field_idx, void* dst){
	...
	case 5: memcpy(dst, wIin, _cnt * sizeof(double)); break;
	case 6: memcpy(dst, wFin, _cnt * sizeof(double)); break;
	case 7: memcpy(dst, wOin, _cnt * sizeof(double)); break;
	case 8: memcpy(dst, win, _cnt * sizeof(double)); break;
	case 9: memcpy(dst, wIr, _cnt * sizeof(double)); break;
	case 10: memcpy(dst, wFr, _cnt * sizeof(double)); break;
	case 11: memcpy(dst, wOr, _cnt * sizeof(double)); break;
	case 12: memcpy(dst, wr, _cnt * sizeof(double)); break;
	case 13: memcpy(dst, wI, _cnt * sizeof(double)); break;
	case 14: memcpy(dst, wF, _cnt * sizeof(double)); break;
	case 15: memcpy(dst, wO, _cnt * sizeof(double)); break;
	case 16: memcpy(dst, bO, _cnt * sizeof(double)); break;
	case 17: memcpy(dst, bF, _cnt * sizeof(double)); break;
	case 18: memcpy(dst, bI, _cnt * sizeof(double)); break;
	case 19: memcpy(dst, b, _cnt * sizeof(double)); break;
	case 20: memcpy(dst, u, _cnt * sizeof(double)); break;
	case 21: memcpy(dst, s, _cnt * sizeof(double)); break;
	case 22: memcpy(dst, uI, _cnt * sizeof(double)); break;
	case 23: memcpy(dst, uF, _cnt * sizeof(double)); break;
	case 24: memcpy(dst, uO, _cnt * sizeof(double)); break;
	case 25: memcpy(dst, delta_x, _cnt * sizeof(double)); break;
	case 26: memcpy(dst, delta_y, _cnt * sizeof(double)); break;
	case 27: memcpy(dst, delta_wIin, _cnt * sizeof(double)); break;
	case 28: memcpy(dst, delta_wFin, _cnt * sizeof(double)); break;
	case 29: memcpy(dst, delta_wOin, _cnt * sizeof(double)); break;
	case 30: memcpy(dst, delta_win, _cnt * sizeof(double)); break;
	case 31: memcpy(dst, delta_wIr, _cnt * sizeof(double)); break;
	case 32: memcpy(dst, delta_wFr, _cnt * sizeof(double)); break;
	case 33: memcpy(dst, delta_wOr, _cnt * sizeof(double)); break;
	case 34: memcpy(dst, delta_wr, _cnt * sizeof(double)); break;
	case 35: memcpy(dst, delta_wI, _cnt * sizeof(double)); break;
	case 36: memcpy(dst, delta_wF, _cnt * sizeof(double)); break;
	case 37: memcpy(dst, delta_wO, _cnt * sizeof(double)); break;
	case 38: memcpy(dst, delta_bO, _cnt * sizeof(double)); break;
	case 39: memcpy(dst, delta_bF, _cnt * sizeof(double)); break;
	case 40: memcpy(dst, delta_bI, _cnt * sizeof(double)); break;
	case 41: memcpy(dst, delta_b, _cnt * sizeof(double)); break;
	case 42: memcpy(dst, delta_u, _cnt * sizeof(double)); break;
	case 43: memcpy(dst, delta_s, _cnt * sizeof(double)); break;
	case 44: memcpy(dst, delta_uI, _cnt * sizeof(double)); break;
	case 45: memcpy(dst, delta_uF, _cnt * sizeof(double)); break;
	case 46: memcpy(dst, delta_uO, _cnt * sizeof(double)); break;
	}
}

void LSTMLayerCudaD::SetFieldValue(int field_idx, void* src){
	int _cnt = GetFieldElementCount(field_idx);
	switch(field_idx){
	...
	case 5: memcpy(wIin, src, _cnt * sizeof(double)); break;
	case 6: memcpy(wFin, src, _cnt * sizeof(double)); break;
	case 7: memcpy(wOin, src, _cnt * sizeof(double)); break;
	case 8: memcpy(win, src, _cnt * sizeof(double)); break;
	case 9: memcpy(wIr, src, _cnt * sizeof(double)); break;
	case 10: memcpy(wFr, src, _cnt * sizeof(double)); break;
	case 11: memcpy(wOr, src, _cnt * sizeof(double)); break;
	case 12: memcpy(wr, src, _cnt * sizeof(double)); break;
	case 13: memcpy(wI, src, _cnt * sizeof(double)); break;
	case 14: memcpy(wF, src, _cnt * sizeof(double)); break;
	case 15: memcpy(wO, src, _cnt * sizeof(double)); break;
	case 16: memcpy(bO, src, _cnt * sizeof(double)); break;
	case 17: memcpy(bF, src, _cnt * sizeof(double)); break;
	case 18: memcpy(bI, src, _cnt * sizeof(double)); break;
	case 19: memcpy(b, src, _cnt * sizeof(double)); break;
	case 20: memcpy(u, src, _cnt * sizeof(double)); break;
	case 21: memcpy(s, src, _cnt * sizeof(double)); break;
	case 22: memcpy(uI, src, _cnt * sizeof(double)); break;
	case 23: memcpy(uF, src, _cnt * sizeof(double)); break;
	case 24: memcpy(uO, src, _cnt * sizeof(double)); break;
	case 25: memcpy(delta_x, src, _cnt * sizeof(double)); break;
	case 26: memcpy(delta_y, src, _cnt * sizeof(double)); break;
	case 27: memcpy(delta_wIin, src, _cnt * sizeof(double)); break;
	case 28: memcpy(delta_wFin, src, _cnt * sizeof(double)); break;
	case 29: memcpy(delta_wOin, src, _cnt * sizeof(double)); break;
	case 30: memcpy(delta_win, src, _cnt * sizeof(double)); break;
	case 31: memcpy(delta_wIr, src, _cnt * sizeof(double)); break;
	case 32: memcpy(delta_wFr, src, _cnt * sizeof(double)); break;
	case 33: memcpy(delta_wOr, src, _cnt * sizeof(double)); break;
	case 34: memcpy(delta_wr, src, _cnt * sizeof(double)); break;
	case 35: memcpy(delta_wI, src, _cnt * sizeof(double)); break;
	case 36: memcpy(delta_wF, src, _cnt * sizeof(double)); break;
	case 37: memcpy(delta_wO, src, _cnt * sizeof(double)); break;
	case 38: memcpy(delta_bO, src, _cnt * sizeof(double)); break;
	case 39: memcpy(delta_bF, src, _cnt * sizeof(double)); break;
	case 40: memcpy(delta_bI, src, _cnt * sizeof(double)); break;
	case 41: memcpy(delta_b, src, _cnt * sizeof(double)); break;
	case 42: memcpy(delta_u, src, _cnt * sizeof(double)); break;
	case 43: memcpy(delta_s, src, _cnt * sizeof(double)); break;
	case 44: memcpy(delta_uI, src, _cnt * sizeof(double)); break;
	case 45: memcpy(delta_uF, src, _cnt * sizeof(double)); break;
	case 46: memcpy(delta_uO, src, _cnt * sizeof(double)); break;
	}
}

LSTMLayerCudaD::LSTMLayerCudaD(int t_size, int x_size, int y_size){
...
void LSTMLayerCudaD::Allocate(){
	...
	_chk(_Malloc(uI, BatchSize * T * Y * sizeof(double))); 
	_chk(_Malloc(uF, BatchSize * T * Y * sizeof(double))); 
	_chk(_Malloc(uO, BatchSize * T * Y * sizeof(double))); 
	_chk(_Malloc(delta_x, BatchSize * T * X * sizeof(double))); 
	_chk(_Malloc(delta_wIin, BatchSize * Y * X * sizeof(double))); 
	_chk(_Malloc(delta_wFin, BatchSize * Y * X * sizeof(double))); 
	_chk(_Malloc(delta_wOin, BatchSize * Y * X * sizeof(double))); 
	_chk(_Malloc(delta_win, BatchSize * Y * X * sizeof(double))); 
	_chk(_Malloc(delta_wIr, BatchSize * Y * Y * sizeof(double))); 
	_chk(_Malloc(delta_wFr, BatchSize * Y * Y * sizeof(double))); 
	_chk(_Malloc(delta_wOr, BatchSize * Y * Y * sizeof(double))); 
	_chk(_Malloc(delta_wr, BatchSize * Y * Y * sizeof(double))); 
	_chk(_Malloc(delta_wI, BatchSize * Y * sizeof(double))); 
	_chk(_Malloc(delta_wF, BatchSize * Y * sizeof(double))); 
	_chk(_Malloc(delta_wO, BatchSize * Y * sizeof(double))); 
	...
	_chk(_Malloc(delta_uI, BatchSize * T * Y * sizeof(double))); 
	_chk(_Malloc(delta_uF, BatchSize * T * Y * sizeof(double))); 
	_chk(_Malloc(delta_uO, BatchSize * T * Y * sizeof(double))); 
}

void LSTMLayerCudaD::Free(){
	_chk(_Free(y)); 
	_chk(_Free(u)); 
	_chk(_Free(s)); 
	_chk(_Free(uI)); 
...
__global__ static void forward_uF(double* uF, int X, double* wFin, double* x, int Y, double* wFr, double* y, double* wF, double* s, double* bF, int T, int t){
...
void LSTMLayerCudaD::Start_forward_uF(){
	int blocks_x = 1;
	int blocks_y = 1;
	int blocks_z = 1;
	blocks_x = Y;
...
__global__ static void forward_uI(double* uI, int X, double* wIin, double* x, int Y, double* wIr, double* y, double* wI, double* s, double* bI, int T, int t){
	int _batch_idx = threadIdx.x;
	int j = blockIdx.x;
...
void LSTMLayerCudaD::Start_forward_uI(){
	int blocks_x = 1;
	int blocks_y = 1;
	int blocks_z = 1;
	blocks_x = Y;
...
__global__ static void forward_u(double* u, int X, double* win, double* x, int Y, double* wr, double* y, double* b, int T, int t){
	int _batch_idx = threadIdx.x;
	int j = blockIdx.x;
...
void LSTMLayerCudaD::Start_forward_u(){
	int blocks_x = 1;
	int blocks_y = 1;
	int blocks_z = 1;
	blocks_x = Y;
...
__global__ static void forward_s(double* s, double* uF, double* uI, double* u, int T, int Y, int t){
	int _batch_idx = threadIdx.x;
	int j = blockIdx.x;
...
void LSTMLayerCudaD::Start_forward_s(){
	int blocks_x = 1;
	int blocks_y = 1;
	int blocks_z = 1;
	blocks_x = Y;
...
__global__ static void forward_uO(double* uO, int X, double* wOin, double* x, int Y, double* wOr, double* y, double* wO, double* s, double* bO, int T, int t){
	int _batch_idx = threadIdx.x;
	int j = blockIdx.x;
...
void LSTMLayerCudaD::Start_forward_uO(){
	int blocks_x = 1;
	int blocks_y = 1;
	int blocks_z = 1;
	blocks_x = Y;
...
__global__ static void forward_y(double* y, double* uO, double* s, int T, int Y, int t){
	int _batch_idx = threadIdx.x;
	int j = blockIdx.x;
...
void LSTMLayerCudaD::Start_forward_y(){
	int blocks_x = 1;
	int blocks_y = 1;
	int blocks_z = 1;
	blocks_x = Y;
...
__global__ static void backward_delta_y(double* delta_y, int Y, double* delta_uO, double* wOr, double* delta_uF, double* wFr, double* delta_uI, double* wIr, double* delta_u, double* wr, int T, int t){
	int _batch_idx = threadIdx.x;
	int j = blockIdx.x;
...
void LSTMLayerCudaD::Start_backward_delta_y(){
	int blocks_x = 1;
	int blocks_y = 1;
	int blocks_z = 1;
	blocks_x = Y;
...
__global__ static void backward_delta_uO(double* delta_uO, double* delta_y, double* uO, double* s, int T, int Y, int t){
	int _batch_idx = threadIdx.x;
	int j = blockIdx.x;
...
void LSTMLayerCudaD::Start_backward_delta_uO(){
	int blocks_x = 1;
	int blocks_y = 1;
	int blocks_z = 1;
	blocks_x = Y;
...
__global__ static void backward_delta_wOin(double* delta_wOin, int T, double* delta_uO, double* x, int Y, int X, int t){
	int _batch_idx = threadIdx.x;
	int j = blockIdx.y;
	int i_i = blockIdx.x;
...
void LSTMLayerCudaD::Start_backward_delta_wOin(){
	int blocks_x = 1;
	int blocks_y = 1;
	int blocks_z = 1;
	blocks_y = Y;
...
__global__ static void backward_delta_wOr(double* delta_wOr, int T, double* delta_uO, double* y, int Y, int t){
	int _batch_idx = threadIdx.x;
	int j = blockIdx.y;
	int i_i = blockIdx.x;
...
void LSTMLayerCudaD::Start_backward_delta_wOr(){
	int blocks_x = 1;
	int blocks_y = 1;
	int blocks_z = 1;
	blocks_y = Y;
...
__global__ static void backward_delta_wO(double* delta_wO, int T, double* delta_uO, double* s, int Y, int t){
	int _batch_idx = threadIdx.x;
	int j = blockIdx.x;
...
void LSTMLayerCudaD::Start_backward_delta_wO(){
	int blocks_x = 1;
	int blocks_y = 1;
	int blocks_z = 1;
	blocks_x = Y;
...
__global__ static void backward_delta_bO(double* delta_bO, int T, double* delta_uO, int Y, int t){
	int _batch_idx = threadIdx.x;
	int j = blockIdx.x;
...
void LSTMLayerCudaD::Start_backward_delta_bO(){
	int blocks_x = 1;
	int blocks_y = 1;
	int blocks_z = 1;
	blocks_x = Y;
...
__global__ static void backward_delta_s(double* delta_s, double* delta_y, double* uO, double* s, double* uF, double* delta_uO, double* wO, double* delta_uF, double* wF, double* delta_uI, double* wI, int T, int Y, int t){
	int _batch_idx = threadIdx.x;
	int j = blockIdx.x;
...
void LSTMLayerCudaD::Start_backward_delta_s(){
	int blocks_x = 1;
	int blocks_y = 1;
	int blocks_z = 1;
	blocks_x = Y;
...
__global__ static void backward_delta_u(double* delta_u, double* delta_s, double* uI, double* u, int T, int Y, int t){
	int _batch_idx = threadIdx.x;
	int j = blockIdx.x;
...
void LSTMLayerCudaD::Start_backward_delta_u(){
	int blocks_x = 1;
	int blocks_y = 1;
	int blocks_z = 1;
	blocks_x = Y;
...
void LSTMLayerCudaD::Start_backward_delta_win(){
	int blocks_x = 1;
	int blocks_y = 1;
	int blocks_z = 1;
	blocks_y = Y;
...
__global__ static void backward_delta_wr(double* delta_wr, int T, double* delta_u, double* y, int Y, int t){
	int _batch_idx = threadIdx.x;
	int j = blockIdx.y;
	int i_i = blockIdx.x;
...
void LSTMLayerCudaD::Start_backward_delta_wr(){
	int blocks_x = 1;
	int blocks_y = 1;
	int blocks_z = 1;
	blocks_y = Y;
...
void LSTMLayerCudaD::Start_backward_delta_b(){
	int blocks_x = 1;
	int blocks_y = 1;
	int blocks_z = 1;
	blocks_x = Y;
...
__global__ static void backward_delta_uI(double* delta_uI, double* delta_s, double* uI, double* u, int T, int Y, int t){
	int _batch_idx = threadIdx.x;
	int j = blockIdx.x;
...
void LSTMLayerCudaD::Start_backward_delta_uI(){
	int blocks_x = 1;
	int blocks_y = 1;
	int blocks_z = 1;
	blocks_x = Y;
...
__global__ static void backward_delta_wIin(double* delta_wIin, int T, double* delta_uI, double* x, int Y, int X, int t){
	int _batch_idx = threadIdx.x;
	int j = blockIdx.y;
	int i_i = blockIdx.x;
...
void LSTMLayerCudaD::Start_backward_delta_wIin(){
	int blocks_x = 1;
	int blocks_y = 1;
	int blocks_z = 1;
	blocks_y = Y;
...
__global__ static void backward_delta_wIr(double* delta_wIr, int T, double* delta_uI, double* y, int Y, int t){
	int _batch_idx = threadIdx.x;
	int j = blockIdx.y;
	int i_i = blockIdx.x;
...
void LSTMLayerCudaD::Start_backward_delta_wIr(){
	int blocks_x = 1;
	int blocks_y = 1;
	int blocks_z = 1;
	blocks_y = Y;
...
__global__ static void backward_delta_wI(double* delta_wI, int T, double* delta_uI, double* s, int Y, int t){
	int _batch_idx = threadIdx.x;
	int j = blockIdx.x;
...
void LSTMLayerCudaD::Start_backward_delta_wI(){
	int blocks_x = 1;
	int blocks_y = 1;
	int blocks_z = 1;
	blocks_x = Y;
...
__global__ static void backward_delta_bI(double* delta_bI, int T, double* delta_uI, int Y, int t){
	int _batch_idx = threadIdx.x;
	int j = blockIdx.x;
...
void LSTMLayerCudaD::Start_backward_delta_bI(){
	int blocks_x = 1;
	int blocks_y = 1;
	int blocks_z = 1;
	blocks_x = Y;
...
__global__ static void backward_delta_uF(double* delta_uF, double* delta_s, double* uF, double* s, int T, int Y, int t){
	int _batch_idx = threadIdx.x;
	int j = blockIdx.x;
...
void LSTMLayerCudaD::Start_backward_delta_uF(){
	int blocks_x = 1;
	int blocks_y = 1;
	int blocks_z = 1;
	blocks_x = Y;
...
__global__ static void backward_delta_x(double* delta_x, int Y, double* delta_uO, double* wOin, double* delta_uF, double* wFin, double* delta_uI, double* wIin, double* delta_u, double* win, int T, int X, int t){
	int _batch_idx = threadIdx.x;
	int i_i = blockIdx.x;
...
void LSTMLayerCudaD::Start_backward_delta_x(){
	int blocks_x = 1;
	int blocks_y = 1;
	int blocks_z = 1;
	blocks_x = X;
...
__global__ static void backward_delta_wFin(double* delta_wFin, int T, double* delta_uF, double* x, int Y, int X, int t){
	int _batch_idx = threadIdx.x;
	int j = blockIdx.y;
	int i_i = blockIdx.x;
...
void LSTMLayerCudaD::Start_backward_delta_wFin(){
	int blocks_x = 1;
	int blocks_y = 1;
	int blocks_z = 1;
	blocks_y = Y;
...
__global__ static void backward_delta_wFr(double* delta_wFr, int T, double* delta_uF, double* y, int Y, int t){
	int _batch_idx = threadIdx.x;
	int j = blockIdx.y;
	int i_i = blockIdx.x;
...
void LSTMLayerCudaD::Start_backward_delta_wFr(){
	int blocks_x = 1;
	int blocks_y = 1;
	int blocks_z = 1;
	blocks_y = Y;
...
__global__ static void backward_delta_wF(double* delta_wF, int T, double* delta_uF, double* s, int Y, int t){
	int _batch_idx = threadIdx.x;
	int j = blockIdx.x;
...
void LSTMLayerCudaD::Start_backward_delta_wF(){
	int blocks_x = 1;
	int blocks_y = 1;
	int blocks_z = 1;
	blocks_x = Y;
...
__global__ static void backward_delta_bF(double* delta_bF, int T, double* delta_uF, int Y, int t){
	int _batch_idx = threadIdx.x;
	int j = blockIdx.x;
...
void LSTMLayerCudaD::Start_backward_delta_bF(){
	int blocks_x = 1;
	int blocks_y = 1;
	int blocks_z = 1;
	blocks_x = Y;
...
__global__ static void UpdateParameterKernel_0(double* wIin, double* delta_wIin, double* wFin, double* delta_wFin, double* wOin, double* delta_wOin, double* win, double* delta_win){
...
void LSTMLayerCudaD::UpdateParameter_0(){
	int threads_x = 1;
	int blocks_x = 1;
	int blocks_y = 1;
	int blocks_z = 1;
...
__global__ static void UpdateParameterKernel_1(double* wIr, double* delta_wIr, double* wFr, double* delta_wFr, double* wOr, double* delta_wOr, double* wr, double* delta_wr){
	int _idx = (blockIdx.x) * blockDim.x + threadIdx.x;
	int offset = _idx * _BatchSize;
	{
		double sum = 0;
...
void LSTMLayerCudaD::UpdateParameter_1(){
	int threads_x = 1;
	int blocks_x = 1;
	int blocks_y = 1;
	int blocks_z = 1;
...
__global__ static void UpdateParameterKernel_2(double* wI, double* delta_wI, double* wF, double* delta_wF, double* wO, double* delta_wO, double* bO, double* delta_bO, double* bF, double* delta_bF, double* bI, double* delta_bI, double* b, double* delta_b){
...
void LSTMLayerCudaD::UpdateParameter_2(){
	int threads_x = 1;
	int blocks_x = 1;
	int blocks_y = 1;
	int blocks_z = 1;
...
void LSTMLayerCudaD::UpdateParameter(){
	_chk(_MemcpyToSymbol(_BatchSize, BatchSize, sizeof(BatchSize)));
...
extern "C" DllExport Layer* MakeLSTMLayerCudaD(int t_size, int x_size, int y_size){
	return new LSTMLayerCudaD(t_size, x_size, y_size);
}
