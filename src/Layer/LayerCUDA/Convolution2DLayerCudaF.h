class DllExport Convolution2DLayerCudaF : public LayerCuda {
public:
    int M;
    int N;
    int K;
	...
	Convolution2DLayerCudaF(int m_size, int n_size, int k_size, int cm_size, int cn_size);
	virtual ~Convolution2DLayerCudaF();
