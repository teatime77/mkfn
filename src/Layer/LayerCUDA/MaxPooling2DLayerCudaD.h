class DllExport MaxPooling2DLayerCudaD : public LayerCuda {
public:
    int M;
    int N;
    int K;
	...
	MaxPooling2DLayerCudaD(int m_size, int n_size, int k_size, int pm_size, int pn_size);
	virtual ~MaxPooling2DLayerCudaD();
